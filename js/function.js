// const getStringLength = (string, stringLength) => {
//   return string.length <= stringLength;
// };

// console.log(getStringLength("qwertyu", 6));

// const getIsStringPalindrom = (string) => {
//   let updateString = string.replace(/\s/g, "");
//   let arrayOfSymbols = updateString.toLowerCase().split("");
...
getStringWithAdditional('1', 2, '0');      // '01'

// Добавочный символ использован три раза
getStringWithAdditional('1', 4, '0');      // '0001'

// Добавочные символы обрезаны с конца
getStringWithAdditional('q', 4, 'werty');  // 'werq'

// Добавочные символы использованы полтора раза
getStringWithAdditional('q', 4, 'we');     // 'wweq'

// Добавочные символы не использованы, исходная строка не изменена
getStringWithAdditional('qwerty', 4, '0'); // 'qwerty'
